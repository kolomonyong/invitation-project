...
import { InView, InViewScale } from '@/components/motion/in-view';
  ...
  if (!isOpen) {
    return (
      <div className="bg-white font-lato">
        <div className="max-w-md mx-auto bg-[#fedfe3] min-h-screen relative flex flex-col items-center justify-center text-center p-8">
          <FloatingParticles count={12} color="#c39aa0" minSize={2} maxSize={4} />
          <div className="relative z-10">
            <TextEffect per="word" delay={0.3} className="text-lg text-[#965a00] mb-2" as="p">
              You are invited to the wedding of
            </TextEffect>
            <TextEffect
              per="word"
              delay={0.8}
              className="text-4xl font-bold text-[#965a00] mb-6"
              as="h1"
            ...
            <motion.button
              ...
              className="bg-[#965a00] text-white font-bold py-3 px-8 rounded-full shadow-lg"
        ...
        <div className="max-w-md mx-auto bg-[#fedfe3] min-h-screen relative">
          ...
          <main className="pt-[55px]">
            ...
            {custom_data.couplePhoto && (
              <InView variants={{ hidden: { opacity: 0, scale: 1.05 }, visible: { opacity: 1, scale: 1 } }}>
            ...
            <section className="mx-4">
              <InViewScale transition={{ duration: 0.5 }}>
            ...
            <section className="mx-4 mt-8 space-y-6">
              <InView transition={{ duration: 0.5, delay: 0.1 }}>
            ...
            <section className="mx-4 my-8">
              <InView transition={{ duration: 0.5 }}>
                <div className="bg-white rounded-lg p-6 shadow-lg">
